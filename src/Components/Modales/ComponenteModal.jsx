                            ...
                            validate={values =>{
                                const errors={};
                                    if(!values.componente){
                                        errors.componente = 'Componente es requerido'
                                    }
                                return errors;
                            }}
                            onSubmit={async(values,{setSubmitting}) => {
                                if(!isEdit){
                                    ...
                                    try {
                                        ...
                                        .eq("id_componente", values.idComponente)
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
                                            <div>
                                                <div className="relative w-full group">
                                                    <span className={`absolute -left-0.5 top-2 bottom-2 w-1.5 rounded bg-gradient-to-b  ${errors.componente && touched.componente ? 'from-red-700 to-red-400' : 'from-blue-500 to-cyan-500'} opacity-70 transition-all duration-300 group-focus-within:opacity-100`} />
                                                    <input type="text" id="componente" value={values.componente} onChange={handleChange} placeholder=" "
                                                        ...
                                                        ${(values.componente !== '' ? 'border-blue-500 ring-2 ring-indigo-300' : 'border-gray-200 focus:ring-2 focus:ring-indigo-300 focus:border-transparent') +
                                                            (errors.componente && touched.componente ? ' border-red-500 ring-2 ring-red-300' : '') 
                                                        } 
                                                        `}
                                                    />
                                                    <label htmlFor="componente"
                                                        ...
                                                        ${(values.componente !== ''
                                                            ...
                                                            : 'top-3.5 text-base text-gray-500') + (errors.componente && touched.componente ? ' text-red-500' : '') 
                                                        }
                                                    ...
                                                    {errors.componente && touched.componente && <div className="text-red-500">{errors.componente}</div>}
                                            </div>
                                        </div>
