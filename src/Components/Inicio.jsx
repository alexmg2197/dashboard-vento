const Inicio = () => {
    return(
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 p-4">
            <div className="group w-full rounded-lg bg-red-900 p-5 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_#1e3a8a]">
            ...
            <div className="group w-full rounded-lg bg-green-900 p-5 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_#1e3a8a]">
            ...
            <div className="group w-full rounded-lg bg-pink-900 p-5 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_#1e3a8a]">
                <p className="text-white text-2xl">2000</p>
                <p className="text-white text-sm">lorem</p>
                <svg xmlSpace="preserve" style={{enableBackground: 'new 0 0 512 512'}} viewBox="0 0 512 512" y={0} x={0} height={36} width={36} xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" xmlns="http://www.w3.org/2000/svg" className="group-hover:opacity-100 absolute right-[10%] top-[50%] translate-y-[-50%] opacity-20 transition group-hover:scale-110 duration-300">
                <g>
            ...
            <div className="group w-full rounded-lg bg-purple-900 p-5 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_#1e3a8a]">
                <p className="text-white text-2xl">1999</p>
                <p className="text-white text-sm">lorem</p>
                <svg className="group-hover:opacity-100 absolute right-[10%] top-[50%] translate-y-[-50%] opacity-20 transition group-hover:scale-110 duration-300" xmlSpace="preserve" style={{enableBackground: 'new 0 0 512 512'}} viewBox="0 0 405.333 405.333" y={0} x={0} height={36} width={36} xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" xmlns="http://www.w3.org/2000/svg">
                <g>
            ...
            <div className="group w-full rounded-lg bg-orange-900 p-5 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_#1e3a8a]">
                <p className="text-white text-2xl">1999</p>
                <p className="text-white text-sm">lorem</p>
                <svg className="group-hover:opacity-100 absolute right-[10%] top-[50%] translate-y-[-50%] opacity-20 transition group-hover:scale-110 duration-300" xmlSpace="preserve" style={{enableBackground: 'new 0 0 512 512'}} viewBox="0 0 405.333 405.333" y={0} x={0} height={36} width={36} xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" xmlns="http://www.w3.org/2000/svg">
                <g>
